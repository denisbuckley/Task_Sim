...
# ASG 29 — 18 m, heavy case m=1268 lb, W/S ≈ 9.91 lb/ft² (sink is ft/min on chart → m/s here)
# Source: your uploaded plot (preliminary working hypothesis). Digitized by eye.
# Points are given in km/h with sink in m/s.
POLAR_ASG29_18M_1268LB: list[tuple[float, float]] = [
    (80.0, 0.70),
    (90.0, 0.65),
    (100.0, 0.66),
    (110.0, 0.70),   # ≈ min sink around here
    (120.0, 0.78),
    (130.0, 0.87),
    (140.0, 0.98),
    (150.0, 1.10),
...
# Ventus 2cx — 18 m, all-up mass 565 kg / 1246 lb (right-hand curve)
# Using lower x-axis (km/h) and right-hand y-axis (m/s). Digitized by eye.
POLAR_VENTUS2CX_18M_565: list[tuple[float, float]] = [
    (80.0, 0.45),
    (90.0, 0.55),
    (100.0, 0.65),
    (110.0, 0.75),
...
# JS3 RES — 18 m, 60 kg/m² (rightmost red curve)
# Source: factory performance chart; digitized by eye.
POLAR_JS3_18M_60: list[tuple[float, float]] = [
    (90.0, 0.45),
    (100.0, 0.52),
    (110.0, 0.60),
    (120.0, 0.70),
...
POLARS: Dict[str, List[Tuple[float, float]]] = {
    ...
    "asg29_18m_1268lb": POLAR_ASG29_18M_1268LB,
    "ventus2cx_18m_565": POLAR_VENTUS2CX_18M_565,
...
def main():
    ...
    color_for = {
        ...
        "asg29_18m_1268lb": "tab:green",
        "ventus2cx_18m_565": "tab:purple",
        "js3_18m_60": "tab:orange",
    }
